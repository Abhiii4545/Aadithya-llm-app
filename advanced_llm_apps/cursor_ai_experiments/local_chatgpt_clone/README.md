...
cd Aadithya-LLM-Hub/advanced_tools_frameworks/local_chatgpt_clone
```
...
4. Expose the Llama-3 model as an OpenAI API by starting the server in LM Studio. Watch this [video walkthrough](https://x.com/Abhiii4545/status/1783715814790549683).
